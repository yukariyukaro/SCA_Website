      ...
      <div className="relative flex flex-col py-2 lg:py-4 px-4 lg:px-6">
        <div className="flex items-start justify-start gap-2 lg:gap-3 w-full">
          <ImageWithState
            ...
            containerClassName="h-10 lg:h-16 w-10 lg:w-16 rounded-full border-2 lg:border-3 border-white bg-white shrink-0"
          />
        ...
        <div className="absolute right-3 lg:right-6 h-full w-16 sm:w-24 md:w-40 lg:w-48">
          <ImageWithState
            ...
            alt="花朵装饰1"
            containerClassName="w-[30px] h-[30px] sm:w-[40px] sm:h-[40px] md:w-[48px] md:h-[48px] lg:w-[58px] lg:h-[58px] absolute -top-2 lg:-top-4 right-[40%] z-10"
            className="h-full w-full"
          />
          <ImageWithState
            src="img/home/flower3.svg"
            alt="花朵装饰3"
            containerClassName="w-[30px] h-[30px] sm:w-[40px] sm:h-[40px] md:w-[48px] md:h-[48px] lg:w-[58px] lg:h-[58px] absolute top-[20%] right-0 z-10"
            className="h-full w-full"
          />
          <ImageWithState
            src="img/home/flower2.svg"
            alt="花朵装饰2"
            containerClassName="w-[30px] h-[30px] sm:w-[36px] sm:h-[36px] md:w-[44px] md:h-[44px] lg:w-[52px] lg:h-[52px] absolute -bottom-3 lg:-bottom-5 right-[30%] z-10"
            className="h-full w-full"
          />
        </div>
      </div>
